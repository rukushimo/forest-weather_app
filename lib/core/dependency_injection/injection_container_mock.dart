...
import 'package:weather_app/features/weather/presentation/bloc/search_bloc.dart';
...
import '../../features/weather/data/datasources/weather_remote_data_source_mock.dart';
...
Future<void> initMock() async {
  ...
  // Data sources - Using MOCK instead of real API
  sl.registerLazySingleton<WeatherRemoteDataSource>(
    () => WeatherRemoteDataSourceMock(), // No API key needed!
  );
